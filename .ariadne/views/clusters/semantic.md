...
|------|------|------:|---:|----:|-----------:|
| `src/semantic/dotnet.rs` | source | 2 | 1 | 3 | 0.0000 |
...
| `src/semantic/java.rs` | source | 2 | 1 | 3 | 0.0000 |
| `src/semantic/mod.rs` | source | 2 | 7 | 7 | 0.0007 |

## Internal Dependencies

- `src/semantic/dotnet.rs` → `src/semantic/mod.rs` (imports)
- `src/semantic/events.rs` → `src/semantic/mod.rs` (imports)
- `src/semantic/http.rs` → `src/semantic/mod.rs` (imports)
- `src/semantic/java.rs` → `src/semantic/mod.rs` (imports)
- `src/semantic/mod.rs` → `src/semantic/dotnet.rs` (imports)
...
- `src/semantic/mod.rs` → `src/semantic/java.rs` (imports)

## External Dependencies

- `src/semantic/dotnet.rs` → `src/model/semantic.rs` (imports)
- `src/semantic/dotnet.rs` → `src/model/types.rs` (imports)
...
- `src/semantic/java.rs` → `src/model/semantic.rs` (imports)
- `src/semantic/java.rs` → `src/model/types.rs` (imports)
