...
| `src/detect/filetype.rs` | source | 2 | 1 | 1 | 0.0001 |
| `src/detect/layer.rs` | source | 2 | 1 | 1 | 0.0001 |
| `src/detect/mod.rs` | source | 4 | 4 | 4 | 0.0012 |
| `src/detect/workspace.rs` | source | 3 | 1 | 3 | 0.0002 |
