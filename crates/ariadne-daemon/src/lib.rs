...
//! engine + warm-graph dump used by the tier-08 incrementality test, the
//! redb-open serialization handle the composition root's re-walk uses
//! (`IndexLock`, tier-11a), the pure path + status policy, and the crate error
//! type. No logic in this file [src: docs/folder-layout.md rule 3].
